...
import { PANEL_PLAYGROUND_TAG_NAME, PLAYGROUND_REQUESTS } from './constant.js';
...
@wfElement(PANEL_PLAYGROUND_TAG_NAME)
export class WfLockxyPanelPlayground extends LitElement {
...
declare global {
    interface HTMLElementTagNameMap {
        'wf-lockxy-panel-playground': WfLockxyPanelPlayground;
    }
}
