...
See the [full documentation](https://wesflo.github.io/lockxy/) for naming precedence, manifests, delays, status responses, bypass cookies, and the optional proxy panel.
